...
response = WS.sendRequest(findTestObject('API/Register', [('baseUrl') : GlobalVariable.baseUrl]))
...
CustomKeywords.'helper.jsonSchemaAssertion.registerJsonSchemaAssertion'(response)
